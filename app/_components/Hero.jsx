  ...
  <div className="mx-auto px-4 py-24 lg:flex lg:h-screen lg:items-center">
    <div className="mx-auto max-w-xl text-center">
      ...
      <div className="mt-8 flex flex-wrap justify-center gap-4">
        ...
        <a
          className="block w-full rounded border border-white px-12 py-3 text-sm font-medium text-white hover:border-blue-500 hover:bg-blue-500 focus:outline-none focus:ring active:bg-blue-500 sm:w-auto"
          href="#"
        >
          Learn More
        </a>
